...
describe('CardAPI', () => {
  ...
  test('CardAPI.getCardStrict() obeys case', () => {
    const lowerPromise = T.sut.getCardStrict('dark confidant')
    const normalPromise = T.sut.getCardStrict('Dark Confidant')
    return lowerPromise.then(lower =>
