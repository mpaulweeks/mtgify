...
class CardListDiff extends _TextListener {
  handleInnerText(textContent) {
    const options = {}
    const self = this
    const title = document.createElement('auto-card-list-diff-title')
    ...
    title.appendChild(self.metaList)
...
class CardListDiffTitle extends HTMLElement {}
...
customElements.define('auto-card-list-diff-title', CardListDiffTitle)
