  ...
  attachCardMetaData(cardName, card, config) {
    ...
    switch (config.imgSource) {
      case Constants.imgSource.scryfall:
        imgUrl = card.mciSet && card.mciNum && `https://img.scryfall.com/cards/normal/en/${card.mciSet}/${card.mciNum}.jpg`
        break;
      ...
      case Constants.imgSource.urzaCo:
        imgUrl = card.mciSet && card.mciNum && `https://s3.urza.co/cards/${card.mciSet}/front/200dpi/${card.mciNum}.jpg`
        break
